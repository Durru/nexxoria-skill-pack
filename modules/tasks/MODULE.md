...
Tasks decides task intent and task-level routing. Runtime only persists the chosen task structures and state updates.

Executable entrypoint: `modules/tasks/index.js`
