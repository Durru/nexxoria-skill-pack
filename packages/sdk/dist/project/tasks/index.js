import { ensureDir, exists, readTextIfExists, writeFile } from '../../runtime/fs/index.js';
import { getTaskDirectoryPath, getTaskFilePath, getTasksTemplatePath, getStageTasksDirectoryPath, } from '../../runtime/paths/index.js';
...
const ensureTaskFile = (projectRoot, stageId, task) => {
...
export const ensureTasksStructure = (projectRoot, stageId) => {
